...
Documentos directos pal papel

Genera documentos word para digitalizar el proceso de escribir Controles de Pedidos

A futuro se incluirá muchos más tipos de documentos

# Páginas

<img src='./docs/Screens.png' alt='Paginas de la aplicacion, con enfasis en la pagina de casa y el splash screen' width='1000' />
...
## Interfaz de Usuario
* [react-feather](https://www.npmjs.com/package/react-feather) - Libreria de Iconos
* [react-data-grid](https://adazzle.github.io/react-data-grid/) - Usar tablas como si fueran de excel
* [react-hook-form](https://www.npmjs.com/package/react-hook-form) - Formularios eficientes, flexibles y extensibles con validación de usuario fácil
